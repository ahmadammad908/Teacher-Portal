...
import { Mail, Lock, User, Eye, EyeOff, AlertCircle, Mail as MailIcon, Shield, Zap, Key, Upload, Settings, HelpCircle, Database, Users, ShieldCheck, Bell, ArrowRight, CheckCircle } from 'lucide-react'
  ...
  return (
    ...
    <div className="min-h-screen ">
      ...
      <div className="lg:hidden">
        ...
        <div className="w-full bg-gradient-to-r from-slate-900 to-gray-900 text-white p-6">
